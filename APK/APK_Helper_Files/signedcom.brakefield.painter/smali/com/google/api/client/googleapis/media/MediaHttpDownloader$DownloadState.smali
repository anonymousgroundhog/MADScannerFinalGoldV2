...
.method static constructor <clinit>()V
    ...
    const-string v2, "MEDIA_IN_PROGRESS"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lcom/google/api/client/googleapis/media/MediaHttpDownloader$DownloadState;-><init>(Ljava/lang/String;I)V
    ...
    .line 70
    new-instance v2, Lcom/google/api/client/googleapis/media/MediaHttpDownloader$DownloadState;

    const-string v3, "MEDIA_COMPLETE"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/google/api/client/googleapis/media/MediaHttpDownloader$DownloadState;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/google/api/client/googleapis/media/MediaHttpDownloader$DownloadState;->MEDIA_COMPLETE:Lcom/google/api/client/googleapis/media/MediaHttpDownloader$DownloadState;

    .line 62
    filled-new-array {v0, v1, v2}, [Lcom/google/api/client/googleapis/media/MediaHttpDownloader$DownloadState;
