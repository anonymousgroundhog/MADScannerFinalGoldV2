.class Lcom/brakefield/painter/Exporter$3;
...
.method constructor <init>(Lcom/brakefield/painter/Exporter;Lcom/brakefield/painter/SharedMessageHandler;Landroid/content/Context;Landroid/view/View;)V
    ...
    .line 167
    iput-object p1, p0, Lcom/brakefield/painter/Exporter$3;->this$0:Lcom/brakefield/painter/Exporter;

    iput-object p2, p0, Lcom/brakefield/painter/Exporter$3;->val$handler:Lcom/brakefield/painter/SharedMessageHandler;

    iput-object p3, p0, Lcom/brakefield/painter/Exporter$3;->val$context:Landroid/content/Context;

    iput-object p4, p0, Lcom/brakefield/painter/Exporter$3;->val$view:Landroid/view/View;
...
.method public onSavedToExternalStorage(Ljava/lang/String;)V
    ...
    .line 174
    iget-object v0, p0, Lcom/brakefield/painter/Exporter$3;->val$handler:Lcom/brakefield/painter/SharedMessageHandler;
...
.method public onSavedToSharedStorage(Landroid/net/Uri;)V
    ...
    iget-object v1, p0, Lcom/brakefield/painter/Exporter$3;->val$context:Landroid/content/Context;

    iget-object v2, p0, Lcom/brakefield/painter/Exporter$3;->val$view:Landroid/view/View;

    new-instance v3, Lcom/brakefield/painter/Exporter$3$$ExternalSyntheticLambda0;

    invoke-direct {v3, v1, v2, p1}, Lcom/brakefield/painter/Exporter$3$$ExternalSyntheticLambda0;-><init>(Landroid/content/Context;Landroid/view/View;Landroid/net/Uri;)V
