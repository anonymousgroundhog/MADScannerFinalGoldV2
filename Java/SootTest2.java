    ...
    public static void main(String[] sootarguments)
    {
        ...
        PackManager.v().getPack("jtp").add(new Transform("jtp.myInstrumenter", new BodyTransformer()
        {
            ...
            {               
                ...
                // if(this_class_name.contains("com.google.android.gms.example.bannerexample.TestClassAdViewAdListener")){
                //     // thisHelper.Print("Testing: "+String.valueOf(this_class.isApplicationClass()));
                //     thisHelper.Print("Testing:"+String.valueOf(this_method.getSource()));
                // }
