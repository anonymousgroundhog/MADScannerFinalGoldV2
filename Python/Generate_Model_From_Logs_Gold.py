...
class Generate_Model_From_Logs_Gold:
	def __init__(self):
		self.logs_path = '';
		self.df = '';
...
model = Generate_Model_From_Logs_Gold()
model.Set_List_Valid_Methods(["setContentView", "setAdListener", "initialize", "onAdImpression", "onAdClicked", "onAdLoaded", "onAdClosed"])
