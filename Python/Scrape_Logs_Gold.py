...
blockchain.Set_Contract_Address('0x59591289617Bb065554161dCd3a9D4738C9fB9a3')
...
for index, row in most_recent_logs.iterrows():
    blockchain.Add_Data(row['hashes'],row['hashes'], row['classes'], row['methods'], str(row['dates']))


# print(blockchain.Read_Data('f01c07cd791bcfe5a46317e1d5907ccddbe00d7e73a6288bf24b8f414e5796d3'))